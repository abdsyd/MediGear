          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                //todo : make it tags
                SearchChoices<CategoryModel>.multiple(
                  // items: addProductController.childCategories
                  //     .map(
                  //       (e) => DropdownMenuItem(
                  //         value: e,
                  //         child: Text(
                  ...
                  selectedItems: addProductController.selectedItemsIndexes,
                  hint: "Select items",
                  searchHint: "Select items",
                  onChanged: (value) {
                    //addProductController.selectedItemsIndexes = value;
                  },
                  isExpanded: true,
                  selectedValueWidgetFn: (CategoryModel category) => Chip(
                    ...
                    // onDeleted: () {
                    //   int index = addProductController.childCategories.indexOf(category);
                    //   addProductController.removeTag(index);
                    // },
                  ),
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    // todo: add the product and validate fields
                    print(addProductController.childCategories);
                    Get.back();
                  },
                  child: const Text(
                    'Add',
